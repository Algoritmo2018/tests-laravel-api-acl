...
test('should return users total_per_page', function () {
...
describe('validations', function () {
    test('should validate create new user', function () {
        postJson(route('users.store'), [], [
            'Authorization' => 'Bearer ' . $this->token
        ])->assertStatus(422)->assertJsonValidationErrors(['name' => trans('validation.required', ['attribute' => 'name']), 'email' => trans('validation.required', ['attribute' => 'email']), 'password' => trans('validation.required', ['attribute' => 'password'])]);
    });
...
test('should return user', function () {
 ...
 test('should return 404 when user not found', function () {
    $response = getJson(route('users.show', 'fake_id'), [
     'Authorization' => 'Bearer ' . $this->token
    ])->assertNotFound();
 });
